...
public class WheelView extends View {
    ...
    private void init(Context context) {
        ...
        mPaint.setColor(getResources().getColor(R.color.dialog_wheel_unselect_text));
        ...
        selectPaint.setColor(getResources().getColor(R.color.textOrange));
        ...
        centerLinePaint.setColor(getResources().getColor(R.color.dialog_wheel_unselect_text));
    ...
    public void setBackground(Drawable background) {
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                ...
                centerLinePaint.setColor(getResources().getColor(R.color.dialog_wheel_bg));
